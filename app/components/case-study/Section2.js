...
const Section2 = ({ section }) => {
  return (
    <div>
      {section?.image1 && (
        <div className="mr-2 lg:mr-[70px] ml-2 lg:ml-[90px] mt-16 max-h-[800px] bg-tcs-black rounded-3xl lg:max-w-full">
          <img
            src={section?.image1}
            className="w-full object-cover sm:h-[800px] rounded-[33px]"
          />
        </div>
      )}
      {section?.image2 && section?.image3 && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mt-4 lg:max-w-full ml-2 lg:ml-[90px] mr-2 lg:mr-[70px] lg:max-h-[800px]">
      ...
      {section?.image6 && (
        <div className="mr-2 lg:mr-[70px] ml-2 lg:ml-[90px] mt-5 lg:mt-4 lg:max-h-[800px] bg-tcs-black rounded-3xl lg:max-w-full">
          <img
            src={section?.image6}
            className="w-full object-cover sm:h-[800px] rounded-[33px]"
          />
